...
- [Crate 与源文件](crates-and-source-files.md)
...
- [内存模型](memory-model.md)
    - [内存分配与生命周期](memory-allocation-and-lifetime.md)
    - [变量](variables.md)
...
- [不安全](unsafety.md)
    ...
    - [视为未定义的行为](behavior-considered-undefined.md)
    - [不视为不安全的行为](behavior-not-considered-unsafe.md)
